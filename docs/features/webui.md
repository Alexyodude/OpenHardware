...
| webui.bridge.process | F0 | rcontrol | exact | planned | - |
| webui.bridge.framing | F0 | rcontrol | exact | planned | - |
| webui.bridge.queueing | F0 | rcontrol | exact | planned | - |
| webui.bridge.disconnect-fails-loudly | F0 | rcontrol | exact | planned | - |
| webui.bridge.localhost-only | F0 | network-log | exact | planned | - |
| webui.api.session-control | F0 | rcontrol | exact | planned | - |
| webui.api.pins-read | F0 | rcontrol | exact | planned | - |
| webui.api.pins-write | F0 | rcontrol | exact | planned | - |
| webui.api.board-io | F0 | rcontrol | exact | planned | - |
| webui.api.parts-list | F0 | rcontrol | exact | planned | - |
| webui.api.parts-io | F0 | rcontrol | exact | planned | - |
| webui.api.parts-add-remove | F0 | rcontrol | exact | planned | - |
| webui.api.parts-config | F0 | rcontrol | exact | planned | - |
| webui.api.firmware-load | F0 | rcontrol | exact | planned | - |
| webui.api.scope | F0 | rcontrol | exact | planned | - |
| webui.api.board-info | F0 | rcontrol | exact | planned | - |
