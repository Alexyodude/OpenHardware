...
| webui.api.parts-add-remove | F0 | rcontrol | exact | done | tests/webui/test_live_oracle.py |
| webui.api.parts-config | F0 | rcontrol | exact | done | tests/webui/test_live_oracle.py |
...
| webui.ui.part-palette | F0 | sim-state | exact | in-progress | - |
| webui.ui.part-place | F0 | sim-state | exact | done | tests/webui/test_live_oracle.py |
| webui.ui.part-remove | F0 | sim-state | exact | done | tests/webui/test_live_oracle.py |
| webui.ui.part-config | F0 | sim-state | exact | done | tests/webui/test_live_oracle.py |
